...
import type { GdanskManifest, GdanskRenderFunction, GdanskRenderResponse, ResolvedGdanskOptions, WidgetDefinition } from "./types";
...
export declare function installDevSSRMiddleware({ options, server, ssrEntry, widgets, }: InstallDevSSRMiddlewareOptions): void;
export declare function importRenderFunction(path: string): Promise<GdanskRenderFunction>;
export declare function processSSRRequest({ assetOrigin, manifest, render, requestBody, viteServer, widgets, }: ProcessSSRRequestOptions): Promise<ProcessSSRRequestResult>;
export {};
