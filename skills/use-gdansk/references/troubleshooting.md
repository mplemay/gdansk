...
| Tailwind or CSS missing in browser | Frontend build or import issue | Confirm CSS is imported from the widget tree and tooling in `views/` is configured | Check generated `.gdansk/**/client.css` after dev startup |
